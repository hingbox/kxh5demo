;(function(window){
  ...
  /**
   * @ignore
   * https://github.com/yiminghe/add-dom-event-listener/blob/master/src/EventBaseObject.js
   */
  ...
  window.EventBaseObject = EventBaseObject

})(window);

;(function(window){
  'use strict';
  var EventBaseObject = window.EventBaseObject;
  ...
  function DomEventObject(nativeEvent) {
    ...
    var isNative = (typeof nativeEvent.stopPropagation === 'function') ||
    ...
    for(var i = 0; i< eventNormalizers.length; i++){
      normalizer = eventNormalizers[i];
  ...
  window.addEventListener = function addEventListener(target, eventType, callback) {
