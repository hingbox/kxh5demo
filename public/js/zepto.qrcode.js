...
(function(window, $){
  ...
  var QRCodeAlg = window.QRCodeAlg;
  ...
  */
  ...
  var namespace = ".elab.zepto.qrcode";
  ...
  /**
   * Represents the Zepto QRcode plugin.
   *
   * @class QRcode
   * @constructor
  ...
  var QRcode = function(element, options){
    this.$e = $(element);
    var options = this.options = extend(true, {}, QRcode.defaults, options);
    this.$e.append(new qrcode(options));
  };
  ...
  $.fn.qrcode = function(option){
    ...
    return this.each(function (){
      ...
      if (!instance){
        $this.data(namespace, (instance = new QRcode(this, options)));
  ...
  $.fn.qrcode.Constructor = QRcode;

  // region no conflict
  $.fn.qrcode.noConflict = function (){
    $.fn.qrcode = old;
    return this;
  };
})(window, Zepto);
